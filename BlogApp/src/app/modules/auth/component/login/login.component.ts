...
import { AdminRouteConfige } from 'src/app/modules/admin/admin-route-confige';
...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // if (userInfo && userInfo?.username && userInfo?.userrole == "Admin" || userInfo?.userrole == "seller") {
    //   this.router.navigate([AdminRouteConfige.adminPparent + '/' + AdminRouteConfige.adminHome]);
    // }
    // else if (userInfo && userInfo?.username && userInfo?.userrole == "buyer") {
